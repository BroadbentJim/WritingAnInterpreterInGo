...
func Test_NextToken2(t *testing.T) {
	input := `let five = 5;
	let ten = 10;
	let add = fn(x, y) {
	x + y;
...
func Test_NextToken3(t *testing.T) {
	input := `let five = 5;
	let ten = 10;
	let add = fn(x, y) {
	x + y;
...
func Test_NextToken4(t *testing.T) {
	input := `let five = 5;
	let ten = 10;
	let add = fn(x, y) {
	x + y;
...
func Test_EQ(t *testing.T) {
	...
	if tok.Type != test.expectedType || tok.Literal != test.expectedLiteral {
		t.Errorf("Tok: %q, %q, Expected: %q, %q", tok.Type, tok.Literal, test.expectedType, test.expectedLiteral)
	}
}
